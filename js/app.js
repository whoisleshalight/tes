(() => {
    ...
    function menuInit() {
        if (document.querySelector(".icon-menu")) document.addEventListener("click", (function(e) {
            const subM = document.querySelector(".menu__sublist");
            if (bodyLockStatus && e.target.closest(".icon-menu")) {
                bodyLockToggle();
                document.documentElement.classList.toggle("menu-open");
                subM.classList.remove("_active");
            }
    ...
    da.init();
    const menuLin = document.querySelector(".menu__link-btn");
    const subList = document.querySelector(".menu__sublist");
    const subLinBack = document.querySelector(".menu__sublink-back");
    menuLin.addEventListener("click", (function(e) {
        subList.classList.toggle("_active");
        menuLin.classList.toggle("_active");
    }));
    subLinBack.addEventListener("click", (function(e) {
        subList.classList.remove("_active");
    }));
    const goTop = document.querySelector(".go-top");
    window.addEventListener("scroll", (function() {
        if (pageYOffset.toFixed(0) >= 300) goTop.classList.add("_active");
        if (pageYOffset.toFixed(0) < 300) goTop.classList.remove("_active");
    }));
    let isMobileT = {
        Android: function() {
            return navigator.userAgent.match(/Android/i);
    ...
    let body = document.querySelector("body");
    if (isMobileT.any()) body.classList.add("touch"); else body.classList.add("mouse");
    ...
    let sections = document.querySelectorAll(".features__item");
